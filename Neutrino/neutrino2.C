...
void neutrino2(){
   ...
   Neutron->Branch("PtotalN",&PtotalN,"PtotalN/D");
   Neutron->Branch("EtotalN",&EtotalN,"EtotalN/D");
   Positron->Branch("PtotalP",&PtotalP,"PtotalP/D");
   Positron->Branch("EtotalP",&EtotalP,"EtotalP/D");
