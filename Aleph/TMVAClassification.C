...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   uygar*/
   dataloader->AddVariable( "PhtAngle",'F');
   dataloader->AddVariable( "PhtEtot",'F');
   dataloader->AddVariable( "Pi0mass",'F');
   ...
   //uygar//dataloader->SetBackgroundWeightExpression( "weight" );
